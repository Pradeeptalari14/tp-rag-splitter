...
> n8n workflow node dividing prompt requests 50/50 via user ID hashes and logging runs in Google Sheets.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-splitter/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-splitter.git
cd tp-rag-splitter
```
...
```bash
kubectl port-forward deployment/tp-rag-splitter 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── traffic_splitter.json     # Main configuration file
```
...
---
*Generated by [RAG Splitter Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-splitter/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
